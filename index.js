...
(function () {
    ...
    update: function () {
      ...
      if (this.playing) {
        ...
        if (this.playingIntro) {
          ...
          // @TODO this.inverted will trigger the NightMode pass as forth arg
  ...
  Obstacle.types = [
    {
      ...
      minSpeed: 0,
      collisionBoxes: [
        new CollisionBox(0, 7, 5, 20),
        new CollisionBox(4, 0, 6, 28),
        new CollisionBox(10, 4, 7, 11),
      ],
    },
    {
      type: "CACTUS_LARGE",
      ...
      minSpeed: 0,
      collisionBoxes: [
        new CollisionBox(0, 12, 7, 30),
        new CollisionBox(8, 0, 7, 38),
        new CollisionBox(13, 10, 10, 30),
      ],
    },
    /*
     * PTERODACTYL Obstacle default
    {
      type: "PTERODACTYL",
      width: 46,
      height: 40,
  ...
  Trex.prototype = {
    ...
    draw: function (x, y) {
      ...
      if (this.status == Trex.status.WAITING) {
        sourceX = this.config.START_X_POS;
      } else {
